...
public interface CostFunction {
     ...
     */
    class MSE implements CostFunction, Serializable {
        @Override
     ...
     */
    class Quadratic implements CostFunction, Serializable {
        @Override
        public String getName() {
            return "Quadratic";
        }
     ...
     */
    class HalfQuadratic implements CostFunction, Serializable {
        @Override
        public String getName() {
